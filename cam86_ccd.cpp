...
bool Cam86CCD::StartExposure(float duration)
{
    ...
    int r = cameraStartExposure (0,PrimaryCCD.getSubX(),PrimaryCCD.getSubY(),PrimaryCCD.getSubW(),PrimaryCCD.getSubH(), duration, true );    //int r = cameraStartExposure(1,0,0,3000,2000, 0.4, true);
